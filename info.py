...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", " {file_name} https://t.me/mavimovie join for more")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "https://t.me/mavimovie join for more")
